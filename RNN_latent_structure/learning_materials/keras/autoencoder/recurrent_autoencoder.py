...
Adding on to this tutorial we add a reccurrent neural network into the center of the network. 
...
# feed in the encoded information into a simple RNN
model.add(Reshape((49,1)))

model.add(SimpleRNN(49, activation = 'relu'))
